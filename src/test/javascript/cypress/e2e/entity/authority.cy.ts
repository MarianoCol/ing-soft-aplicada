...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'a0b6ee81-1766-4db9-b0b1-babe0479ae5d' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('256c5fd6-d5db-4240-aa6c-5c97b643debb');
      cy.get(`[data-cy="name"]`).should('have.value', '256c5fd6-d5db-4240-aa6c-5c97b643debb');
