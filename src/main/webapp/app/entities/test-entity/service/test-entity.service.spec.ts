...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../test-entity.test-samples';

import { TestEntityService } from './test-entity.service';

const requireRestSample: ITestEntity = {
